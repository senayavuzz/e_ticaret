...
<section class="users">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> kulanıcı adı : <span><?php echo $fetch_users['name']; ?></span> </p>
         ...
         <a href="admin_users.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('delete this user?');" class="delete-btn">kullanıcıyı sil</a>
      </div>
      <?php
         };
      ?>
