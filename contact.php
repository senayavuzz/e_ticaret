...
<div class="heading">
   <h3>İLETİŞİME GEÇ</h3>
   <p> <a href="home.php">anasayfa</a> / iletişim </p>
</div>
...
<section class="contact">
   ...
   <form action="" method="post">
      <h3>Bir şey söyle!</h3>
      <input type="text" name="name" required placeholder="ad" class="box">
      <input type="email" name="email" required placeholder="email" class="box">
      <input type="number" name="number" required placeholder="numara" class="box">
